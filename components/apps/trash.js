...
export class Trash extends Component {
    constructor() {
        ...
        this.trashItems = [
            ...
            {
                name: "old-portfolio-idea.js", 
                icon: "./themes/filetypes/js.png"
            },
            {
                name: "that-one-bug-from-2023", 
                icon: "./themes/Yaru/status/dialog-warning-symbolic.svg" 
            },
            {
                name: "my-first-hello-world-app", 
                icon: "./themes/filetypes/html.png"
            },
            {
                name: "unrealistic-project-plan.pdf", 
