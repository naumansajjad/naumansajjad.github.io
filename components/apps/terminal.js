...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["Certifications", "LahoreGarrisonUniversity", "Education", "Experience", "Interests", "Projects", "Skills", "Contact"],
            LahoreGarrisonUniversity: ["Semester-5"],
            Certifications: ["Multi-AI-Agent-Systems", "Intro-to-Generative-AI", "Google-IT-Automation", "SQL-Databases"],
            Education: ["BSc-Computer-Sciences"],
            Experience: ["Freelance-AI-Developer", "Technical-Support-Assistant"],
            Interests: ["Exploring-AI-tools", "Developing-assistant-applications", "Building-education-tech", "Experimenting-with-automation-LLMs"],
            Projects: ["PrimeWallet-BankingSystem", "AI-Academic-Assistant", "AI-Insightful-Summarizer", "Google-Forms-Auto-Filler", "Multi-Agent-Workflow", "CLI-File-Manager"],
            skills: ["AI-Automation-NLP-RAG", "Programming-Python-C++-React-JS", "Frameworks-Tools", "Web-Development", "Soft-Skills"],
            Contact: ["nauman.sajjad3393@gmail.com", "linkedin/in/naumansajjad", "github.com/naumansajjad"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">nauman_sajjad@Portfolio-OS</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/nauman_sajjad")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found!<br>Available Commands:[ help, cd, ls, whoami, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nauman, todolist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-nauman":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-nauman");
                } else {
                    result = "Command '" + main + "' not found!<br>Available Commands: [ help, cd, ls, whoami, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nauman, todolist, trash, settings, sendmsg ]";
                }
                break;
            ...
            case "sendmsg":
                ...
                break;
            case "whoami":
                result = "You are logged in as nauman_sajjad. To learn more about me, type 'about-nauman'.";
                break;
            case "help":
                result = "All available commands:<br>cd [dir] - change directory<br>ls [dir] - list contents of directory<br>pwd - print working directory<br>echo [text]; - print text<br>clear - clear the terminal<br>exit - close the terminal<br>mkdir [dirname] - make a new directory<br>code - open VS Code<br>spotify - open Spotify<br>chrome - open Chrome<br>about-nauman - learn about Nauman Sajjad<br>todolist - open TodoList<br>trash - open Trash<br>settings - open Settings<br>sendmsg - send a message to Nauman Sajjad<br>whoami - display current user<br>help - show this help message<br>sudo - Rroot user access";
                break;
            case "clear":
                this.reStartTerminal();
                return;
            ...
            case "sudo":
                ...
                ReactGA.event({
                    ...
                    action: "rootuseraccess",
                });

                result = "<img class=' w-2/5' src='./images/memes/used-sudo-command.webp' />";
                break;
            default:
                result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ help, cd, ls, whoami, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nauman, todolist, trash, settings, sendmsg ]";
        }
